...
export async function GET() {
  ...
  const platforms = {
    ...
    instagram: !!(process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET), // Instagram uses FB app
    ...
    threads: !!(process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET),
  }
